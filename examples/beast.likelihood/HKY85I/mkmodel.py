...
The model is HKY85 with empirical nucleotide frequencies,
and the nucleotide order is TCAG.
Rates across sites are modeled using a discretized gamma distribution
plus an invariant site category.
The gamma distribution of rates across sites is discretized
using normalized median rates of quartiles.
...
This script is mostly copied and pasted from the HKY85 example.
...
gamma_shape = 0.587649
gamma_categories = 4
invariable_prior = 0.486548
kappa = 39.464538
...
# This is how hky modifies a symmetric matrix
...
d = dict(model_and_data = dict(
    ...
    normalized_median_gamma_rate_mixture = dict(
