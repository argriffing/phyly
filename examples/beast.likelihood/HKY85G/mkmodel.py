...
The model is HKY85 plus gamma with empirical nucleotide frequencies,
and the nucleotide order is TCAG.
The gamma distribution of rates across sites is discretized
with four categories using normalized median rates of quartiles.
...
d = dict(model_and_data = dict(
    ...
    normalized_median_gamma_rate_mixture = dict(
        gamma_shape=0.137064, gamma_categories=4),
