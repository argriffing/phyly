...
/* The wrapper to the underlying C function */
static PyObject *
py_arbplf_dwell(PyObject *self, PyObject *args)
{
    const char *s_in;
    char *s_out;
    PyObject *ret;
	...
	if (!PyArg_ParseTuple(args, "s:arbplf_dwell", &s_in))
		return NULL;
...
/* The wrapper to the underlying C function */
static PyObject *
py_arbplf_marginal(PyObject *self, PyObject *args)
{
    const char *s_in;
    char *s_out;
    PyObject *ret;
	...
	if (!PyArg_ParseTuple(args, "s:arbplf_marginal", &s_in))
		return NULL;
...
/* The wrapper to the underlying C function */
static PyObject *
py_arbplf_newton_refine(PyObject *self, PyObject *args)
{
    const char *s_in;
    char *s_out;
    PyObject *ret;
	...
	if (!PyArg_ParseTuple(args, "s:arbplf_newton_refine", &s_in))
		return NULL;
    ...
    /* define the json->json map */
    json_hom_t j_hom;
    j_hom->userdata = newton_refine_query;
    j_hom->clear = NULL;
    j_hom->f = arbplf_second_order_run;
    {
        /* define the string->string map */
